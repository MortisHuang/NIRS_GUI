...
PImage calculate;
void LoadImageIcon_Setting() {
  calculate = loadImage("Cal.png");
}
  
void calculator(int offsetX, int offsetY) {
    final int sizeRect = 80;
    image(calculate,offsetX, offsetY, sizeRect, sizeRect);
  }
